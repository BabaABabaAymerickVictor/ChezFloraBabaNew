<?php
// inscription.php
// Page d'inscription pour les nouveaux clients
    ...
    if (empty($email) || empty($password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                // Insérer le nouvel utilisateur (is_deleted = 0) avec le mot de passe en clair
                $query = "INSERT INTO user (email, password, is_deleted) VALUES (:email, :password, 0)";
                $stmt = $conn->prepare($query);
                $stmt->bindParam(':email', $email);
...
<head>
    ...
    <title>ChezFlora - Inscription</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="register-container animate__animated animate__fadeInUp">
        ...
        <h2 class="animate__animated animate__fadeIn">Inscription</h2>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            registerForm.addEventListener('submit', function(e) {
                registerContainer.classList.add('animate__animated', 'animate__fadeOutUp');
            });
        });
    </script>
</body>
