...
<head>
    ...
    <title>ChezFlora - Tableau de Bord Admin</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="dashboard-container animate__animated animate__fadeInUp">
        ...
        <p>
            Vous êtes connecté en tant qu'administrateur. Utilisez la barre de navigation à gauche pour gérer les différentes sections du site ChezFlora.
        </p>
    </div>
